            ...
            <div className="sm:flex mt-8">
                ...
                <div className="sm:w-6/12 border-r">
                    <div className="flex items-center justify-between mt-4 sm:mt-0 px-2">
                        <h2 className="text-lg font-semibold"> Schedule for <time dateTime="2022-01-21">January 21, 2022</time></h2>
                    </div>

                    {/* Inspirations List */}
                    <div
                        className="mt-6 space-y-2 overflow-y-auto h-screen"
                    >
                        {meetings.map((meeting) => (
                            ...
                            >
                                <div className="flex w-full items-center justify-between space-x-2 py-2">
                                    <img alt="" src={meeting.imageUrl} className="size-10 shrink-0 rounded-full bg-gray-300" />
                                    <div className="flex-1 truncate">
                                        <div className="flex items-center space-x-2">
                                            <h3 className="truncate text-sm font-medium text-gray-900">{meeting.name}</h3>

                                        </div>
                                        <p className="mt-1 text-sm text-gray-500"> {meeting.date} at {meeting.time}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
                ...
                <div className="sm:w-8/12 border-l">
                    ...
                    {/* Inspirations List */}
                    <div
                        className="space-y-4 overflow-y-auto max-h-screen px-4"
                    >
                        {inspirations.map((inspiration, index) => (
                            <div
                                key={index}
                                className="boarder border-b"
