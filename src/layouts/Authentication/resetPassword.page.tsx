...
import ResetPasswordForm from "../../components/secondary/ResetPassword";
            ...
            <div className="my-auto sm:mx-auto sm:w-full sm:max-w-md sm:bg-white sm:border sm:rounded-[12px] px-4 py-4" >
                <div className="flex min-h-full flex-col justify-center px-6 py-8 lg:px-8">
                    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <p className="mt-2 text-sm text-center text-gray-900">We will send a link to your email to reset the password to your account</p>
                    </div>
                    <ResetPasswordForm />
                </div>
            </div>
